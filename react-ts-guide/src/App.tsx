	...
	return (
		<div className="App">
			...
			<Content
				...
				code="describe('Given a unit test method', () => { it('when in a test case', () => { const result = plus(4, 3); expect(result).toEqual(7); }); it('when a second case', () => { const result = plus(12, 4); expect(result).toEqual(16); }); });"
				links={[{ label: 'Jest test setup docs', url: 'https://jestjs.io/docs/setup-teardown' }]}
			/>
